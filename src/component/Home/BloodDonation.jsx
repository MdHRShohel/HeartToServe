            ...
            <div className="grid xl:grid-cols-2 gap-8 container">
                ...
                <div className="md:flex  gap-3 bg-gray-50 hover:-translate-y-1 duration-500 ">
                    ...
                    <div className="p-2">
                        ...
                        <p className="mb-4 text-gray-700 text-sm leading-6">O Negative blood cells are called “universal” meaning they can be transfused to almost any patient in need and cells are safest.</p>
