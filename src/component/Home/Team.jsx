            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              ...
              <div className="px-1 py-4 text-[#303030]">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="https://www.facebook.com/MdHRShohel"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/MdHRShohel/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaLinkedin />
                  ...
                  <a
                    href="https://twitter.com/MdHRShohel/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaTwitter />
            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              <div className="relative">
                <div className="overflow-hidden hover:filter hover:brightness-50 duration-300">
                  <img
                    src={
                      "https://i.ibb.co/rdLWVC0/283151442-3209655919289484-7549610066858513993-n.jpg"
                    }
                    className="object-cover h-96 lg:h-72 rounded rounded-t hover:scale-105 duration-300 w-full"
                    alt=""
                  />
              ...
              <div className="px-1 py-4 text-[#303030]">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="https://www.facebook.com/pervez.me/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaFacebookF />
                  ...
                  <a
                    href="https://www.linkedin.com/in/parvez-sakib/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaLinkedin />
            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              <div className="relative">
                <div className="overflow-hidden hover:filter hover:brightness-50 duration-300">
                  <img
                    src={
                      "https://i.ibb.co/6FVS8V6/317087513-1357970454939921-1300632659859450235-n.jpg"
                    }
                    className="object-cover h-96 lg:h-72 rounded rounded-t hover:scale-105 duration-300 w-full"
                    alt=""
                  />
            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              <div className="relative">
                <div className="overflow-hidden hover:filter hover:brightness-50 duration-300">
                  <img
                    src={
                      "https://i.ibb.co/5c0YfxL/banner-420b94fb3ca07c5f895a.png"
                    }
                    className="object-cover h-96 lg:h-72 rounded rounded-t hover:scale-105 duration-300 w-full"
                    alt=""
                  />
            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              <div className="relative">
                <div className="overflow-hidden hover:filter hover:brightness-50 duration-300">
                  <img
                    src={
                      "https://images-ext-2.discordapp.net/external/gLhBBH38A2aPPEevZXwuC12jCx8C0mtgAwc6EIrEjio/https/i.ibb.co/dsYn471/269809561-142393021484628-3183151668269593478-n.jpg"
                    }
                    className="object-cover h-96 lg:h-72 rounded rounded-t hover:scale-105 duration-300 w-full"
                    alt=""
                  />
              ...
              <div className="px-1 py-4 text-[#303030]">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="https://www.facebook.com/mahabub.r03"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaFacebookF />
                  ...
                  <a
                    href="https://www.linkedin.com/in/mahabuburr/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaLinkedin />
            ...
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
              <div className="relative">
                <div className="overflow-hidden hover:filter hover:brightness-50 duration-300">
                  <img
                    src={
                      "https://i.ibb.co/3Sbj2LK/54423194-2183764681953440-9127356419455057920-n.jpg"
                    }
                    className="object-cover h-96 lg:h-72 rounded rounded-t hover:scale-105 duration-300 w-full"
                    alt=""
                  />
              ...
              <div className="px-1 py-4 text-[#303030]">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="https://www.facebook.com/rony688488"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaFacebookF />
                  ...
                  <a
                    href="https://www.linkedin.com/in/mofazzel/"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaLinkedin />
                  ...
                  <a
                    href="https://twitter.com/MofazzelHosse12"
                    target="_blank"
                    className="inline-flex items-center font-semibold bg-[#F36A4F] text-white hover:bg-[#f52d05] duration-300 p-2 rounded-full"
                  >
                    <FaTwitter />
